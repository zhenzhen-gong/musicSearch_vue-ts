<template>
  <div id="app">
    <div class="search-input">
      ...
      <input type="text" placeholder="搜索歌曲" v-model="searchWord" @click="handleToSuggest" />
    ...
    <div class="search-suggest">
      ...
      <div class="search-suggest-item">
        <i class="iconfont icon-sousuo"></i> 少年抖音
      </div>
      <div class="search-suggest-item">
        <i class="iconfont icon-sousuo"></i> 少年抖音
      </div>
...
export default {
  ...
  methods: {
    handleToSuggest() {
      axios.get(`/search/suggest?keywords=${this.suggestWord}&type=mobile`).then((res) => {
        console.log(res)
